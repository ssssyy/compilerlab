...
// 非终结符的类型定义
%type <ast_val> FuncDef FuncType Block Stmt Exp UnaryExp PrimaryExp UnaryOp AddExp MulExp LOrExp LAndExp EqExp RelExp
%type <ast_val> BlockItem BlockItemArr Decl ConstDecl ConstDefArr ConstDef ConstInitVal LVal ConstExp
%type <ast_val> VarDecl VarDefArr VarDef InitVal Condition
%type <int_val> Number
